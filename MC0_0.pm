...
sub _read {
    ...
    elsif ($_on == $CAD::Format::DWG::MC0_0::ENTITIES_BLOCK_INSERT) {
        $self->{data} = CAD::Format::DWG::MC0_0::Entity::EntityBlockInsert->new($self->{_io}, $self, $self->{_root});
    }
    ...
    elsif ($_on == $CAD::Format::DWG::MC0_0::ENTITIES_TMP_BLOCK_INSERT) {
        $self->{data} = CAD::Format::DWG::MC0_0::Entity::EntityBlockInsert->new($self->{_io}, $self, $self->{_root});
    }
...
########################################################################
package CAD::Format::DWG::MC0_0::Entity::EntityBlockInsert;
